...
const {loadMigration,runMigration,SPECS}=require('../lib/b14-order-lifecycle-migration');
test('B14 plan is read only, apply is additive and detects schema conflicts',async()=>{
...
test('B14 CLI rejects implicit connection and wrong confirmation',()=>{
  const cli=path.join(__dirname,'..','scripts','migrate-b14-order-lifecycle.js');
