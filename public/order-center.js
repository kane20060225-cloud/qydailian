(function (global) {
  ...
  function reasonForm(action) {
    ...
    Object.assign(labels,{remove:'确认将订单从订单中心移入回收站？可随时恢复，资金和历史记录保留。未完成的租号订单须先取消，付款审核和进行中订单不能删除。',restore:'确认恢复到订单中心？请填写恢复原因。'});
